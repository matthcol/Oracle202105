...
create table stars(
	id number GENERATED BY DEFAULT ON NULL AS IDENTITY constraint pk_stars primary key,
	name varchar2(150) NOT NULL,
	birthdate date NULL
);

create table movies(
	id number GENERATED BY DEFAULT ON NULL AS IDENTITY constraint pk_movies primary key,	
